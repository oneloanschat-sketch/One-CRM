            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
              <table className="w-full text-right relative">
                <thead className="bg-slate-50 text-slate-600 text-sm font-semibold sticky top-0 z-10 shadow-sm">
                  <tr>
                    <th className="p-4 whitespace-nowrap bg-slate-50">שם הלקוח</th>
                    <th className="p-4 whitespace-nowrap bg-slate-50">טלפון</th>
                    <th className="p-4 whitespace-nowrap bg-slate-50">סכום מבוקש</th>
                    <th className="p-4 whitespace-nowrap bg-slate-50">הכנסה חודשית</th>
                    <th className="p-4 whitespace-nowrap bg-slate-50">תאריך הצטרפות</th>
                    <th className="p-4 whitespace-nowrap bg-slate-50">סטטוס</th>
                    <th className="p-4 whitespace-nowrap bg-slate-50">פעולה</th>
                  </tr>
                </thead>
